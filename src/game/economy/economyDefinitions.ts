...
export type UpgradeId = 'golden_watering_can';
...
export const UPGRADE_CONFIGS: Record<'golden_watering_can', UpgradeDefinition> = {
  golden_watering_can: {
    id: 'golden_watering_can',
    name: 'Golden Watering Can',
    cost: GOLDEN_WATERING_CAN_COST,
    description: 'Waters the crop plus up to eight nearby crops at once',
  },
} as const;
