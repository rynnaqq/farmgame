...
export const ShopModal: React.FC<ShopModalProps> = ({
  ...
  const upgradeCatalog = getUpgradeCatalog(8, goldenCanOwned);
      ...
      >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-amber-300/70">
                Seeds, produce trading & companion eggs
              </p>
            </div>
          </div>
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 bg-slate-900/95 space-y-4">
          ...
          {activeTab === 'seeds' && (
            ...
            >
              <div className="text-xs text-slate-400 mb-1">
                Purchase seeds to plant in your farm beds. Higher tier crops yield greater
          ...
          {activeTab === 'upgrades' && (
            ...
            >
              <div className="text-xs text-slate-400 mb-1">
                Permanent farm upgrades to accelerate crop watering across your beds.
              </div>

              <div className="grid grid-cols-1 gap-3">
                {upgradeCatalog.map((upgrade) => {
                  const isAffordable = coins >= upgrade.cost;
                  const isInteractive = upgrade.isAvailable && !upgrade.isOwned;
